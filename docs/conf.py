...
#
# Upstream fix is to add ``**kwargs`` to the mock signature; tracked at
# https://github.com/git-pull/gp-sphinx/issues/35 — remove this shim
# (and the trailing ``ToolCollector.tool = ...`` assignment) once that
# lands and a release ships.
